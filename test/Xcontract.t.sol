...
contract XcontractTest is Test {
    ...
    function testBinaryVoteCasting() public {
        ...
        vm.prank(user1);
        xContract.castVote(user1, dataIDs, votes);
    ...
    function testBinaryScoreComputation() public {
        ...
        assertEq(totalScore, 50, "Total score for user1 should be 50, corresponding to the standard vote score for a 'Yes'");
    }
}
